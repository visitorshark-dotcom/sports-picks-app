...
# One key works across all of their per-sport subdomains, but each sport
# is a SEPARATE product you must subscribe to individually (free plan is
# fine, but you have to activate it per sport - it's not automatic).
